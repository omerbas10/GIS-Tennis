...
import Symbol from '../../assets/tennis.png';
import './index.css';
		...
		<div className="menu__container">
			<div className="menu__search-bar">
				<div className="search-selector">
					...
					<span>אנא בחר את הסינון הרלוונטי לפיו תרצה למצוא מידע על מגרש   :</span>
					<select defaultValue="name" className="main-filter" onChange={onChangeFilter}>
						<option value="name">שם מגרש</option>
						<option value="openingHours">שעות פעילות  </option>
						<option value="city">עיר</option>
					</select>
					{currentFilter === 'name' ? (
						<input
							type="text"
							placeholder="הקלד את המגרש המבוקש"
						...
						<div className="opening-hours-wrapper">
							...
							>
								<option value={''}>בחר סטטוס מגרש </option>
